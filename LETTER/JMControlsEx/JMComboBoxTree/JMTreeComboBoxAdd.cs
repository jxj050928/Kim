...
namespace JMControlsEx
{
    ...
    /// </summary>
    public partial class JMTreeComboBoxAdd : UserControl
    {
        /// <summary> 
        /// 必需的设计器变量。
        /// </summary>
        ...
        public delegate void ClikeEventHandles(string _text, WizardClickEventArgs e, object sender);
        /// <summary>
        /// 单击添加
        /// </summary>
        public event ClikeEventHandles ClikeAddButton;

        public delegate void ClickItemHandel(string str);

        public event ClickItemHandel ClickSelectButton;
        ...
        public JMTreeComboBoxAdd()
        {
            ...
            this.picbtn.Location = new Point(155, 275);
            this.picbtn.Text = "新增";
            ...
            this.jmtxt.TextChanged += new EventHandler(jmtxt_TextChanged);
        ...
        private void frmTreeView_Deactivate(object sender, EventArgs e)
        {
            ...
            if (!bladdclick && !this.btnSelect.RectangleToScreen(this.btnSelect.ClientRectangle).Contains(Cursor.Position))
        ...
        private void ToggleTreeView(object sender, EventArgs e)
        {
            ...
            if (!this.frmTreeView.Visible)
            {
                ...
                if (CBRect.Y + this.pnlBack.Height + this.frmTreeView.Height > SystemInformation.WorkingArea.Height)
                {
                    this.frmTreeView.Location = new Point(CBRect.X, CBRect.Y - this.frmTreeView.Height);
                }
                else
                {
        ...
        private void SizingGripMouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                this.tvTreeView.Size = new Size(this.frmTreeView.Size.Width - this.lblSizingGrip.Width, this.frmTreeView.Size.Height - 35);//this.lblSizingGrip.Width);
                RelocateGrip();
            }
        }
        ...
        private void TreeViewNodeSelect(object sender, EventArgs e)
        {
            ...
            {
                if (this.tvTreeView.SelectedNode == null || this.tvTreeView.SelectedNode.Nodes.Count == 0)
                {
                    this.tbSelectedValue.Text = this.tvTreeView.SelectedNode.Text;
        ...
        private void ComboBoxTree_Layout(object sender, LayoutEventArgs e)
        {
            ...
            this.tvTreeView.Height = this.frmTreeView.Height - 35;//this.lblSizingGrip.Width;
            this.RelocateGrip();
        }
        ...
        #region 查找
        private void jmtxt_TextChanged(object sender, EventArgs e)
        {
            if (ClickSelectButton != null)
            {
                ClickSelectButton(jmtxt.Text.Trim());
            }
        }
        #endregion
