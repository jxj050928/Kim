...
{
    public class JMTabControl : TabControl
    {
        #region Fields
        ...
        private string[] NewSplit = new string[0];
        #endregion
        ...
        private bool _JMNewVisible;

        public bool JMNewVisible
        {
            get { return _JMNewVisible; }
            set { _JMNewVisible = value; Invalidate(); }
        }
        ...
        public string JMNewText
        {
            ...
            set
            {
                ...
                {
                    NewSplit = _JMNewText.TrimStart(',').TrimEnd(',').Split(',');
                }
                else
                {
                    NewSplit = new string[0];
                }
                Invalidate();
            }
        }
            ...
            Graphics g, TabPage page, Rectangle tabRect, bool hasImage)
        {
            ...
            if (_JMNewVisible)
            {
                ...
                {
                    if (NewSplit[i] == page.Text)
                    {
                        Rectangle rect = new Rectangle(new Point(tabRect.X + tabRect.Width - 13, textRect.Y + 2), new Size(10, 10));

                        g.DrawImage(Properties.Resources._new, rect);
                    }
                }
            }
        }
        ...
        {
            private JMTabControl _owner;
            private bool _bPainting;

            public UpDownButtonNativeWindow(JMTabControl owner)
                : base()
            {
                _owner = owner;
