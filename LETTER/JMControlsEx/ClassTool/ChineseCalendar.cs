...
namespace JMControlsEx
{
    public class ChineseCalendar
    {
        ...
        {
            int x = date.Year;
            if (x % 4 == 0 && x % 100 != 0 || x % 100 == 0 && x % 400 == 0 || x % 4 == 0 && x % 100 == 0 && x % 400 == 0)
            {
                m_rn = true;
            }
            m_SolarDate = date;
        ...
        /// <param name="day">阴历日</param>
        /// <param name="IsLeapMonth">是否闰月</param>
        public static ChineseCalendar FromLunarDate(int year, int month, int day, bool IsLeapMonth)
        {
            DateTime dt = GetDateFromLunarDate(year, month, day, IsLeapMonth);
            return new ChineseCalendar(dt);
        }
        /// <summary>
        /// 从阴历创建日历实体
        /// </summary>
        /// <param name="date">阴历日期</param>
        /// <param name="IsLeapMonth">是否闰月</param>
        public static ChineseCalendar FromLunarDate(DateTime date, bool IsLeapMonth)
        {
        ...
        /// <param name="IsLeapMonth">是否闰月</param>
        public static ChineseCalendar FromLunarDate(string date, bool IsLeapMonth)
        {
        ...
        /// <returns></returns>
        public int Fun_GetYueTianShu(int _year,int _month)
        {
            return calendar.GetDaysInMonth(_year, _month);
        }
