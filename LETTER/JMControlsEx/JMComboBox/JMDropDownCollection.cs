...
{
    public class JMDropDownCollection : IList, ICollection, IEnumerable
    {
        #region FieldsPrivate

        private JMDropDownData m_xpanderPanelList;
        ...
        internal JMDropDownCollection(JMDropDownData xpanderPanelList)
        {
        ...
        public JMComboBoxButton this[int index]
        {
            get { return (JMComboBoxButton)this.m_controlCollection[index] as JMComboBoxButton; }
        }
        ...
        public void CopyTo(JMComboBoxButton[] xpanderPanels, int index)
        {
        ...
        {
            return this.Contains(value as JMComboBoxButton);
        }

        int IList.IndexOf(object value)
        {
            return this.IndexOf(value as JMComboBoxButton);
        }

        void IList.Insert(int index, object value)
        {
            if ((value is JMComboBoxButton) == false)
            {
                throw new ArgumentException();
            }
        }
        ...
        {
            this.Remove(value as JMComboBoxButton);
        }
